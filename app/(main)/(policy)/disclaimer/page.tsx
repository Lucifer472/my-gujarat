    ...
    <section className="w-full h-full flex flex-col items-start gap-y-4 py-6 basic-container px-2 sm:px-2 md:px-4 xl:px-0">
      ...
      <div className="max-w-[750px] mx-auto flex flex-col items-start gap-y-4 w-full">
        <p className="w-full text-left">
          My Gujarat is a metadata-search engine, which mean that different
          search machines of My Gujarat search in more search engines on the
          internet. The results that are displayed by My Gujarat as result of a
          search command of a user, originate from other search engines. My
          Gujarat shows the source of each result in its result list. It is
          possible that My Gujarat shows in the search results direct links to
          ...
          can be found and accessed by using the Website, My Gujarat does not
          ...
          copy and / or download of this material. My Gujarat is never
        ...
        <p className="w-full text-left">
          My Gujarat offers a shopping experience as easy as possible. We have
          relationships with various companies, organizations and entities whose
          products or services may be listed on My Gujarat. If any of those
          products or services are purchased through the links on this website,
          then My Gujarat may be compensated. It may happen that shops
